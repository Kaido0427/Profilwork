...
class Profilfree extends Component
{
    public $step = 1;
    ...
    public function submitStep3()
    {
        ...
        return redirect()->route('Freelance.index')->with('success', 'Profil créé avec succès !');
    ...
    public function render()
    {
        ...
        return view('livewire.profilfree', compact('localites', 'competences', 'compcats'));
    }
}
